...
const  Product  = () => {
    ...
    <Container className="container_center">
        <Row xs={2} md={2} sm={2} className="containerP_margin">
            ...
            <Col>
            <h3 className="precio_product">$/.25.00</h3>
            </Col>
            <Col> 
            <p className="SKU_product">SKU: 76sa6</p>
            </Col>
            <Col>
            <p className="descripcion_product">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </Col>
